 ...
 *
 * Path note: imports the IDL JSON + types from the workspace's anchor build
 * artifacts at `../../target/idl/kommit.json` + `../../target/types/kommit.ts`.
 * Run `anchor build` at the workspace root after pulling new program code.
 */
