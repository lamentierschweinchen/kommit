/** Google "G" logo, inline SVG. Shared between SignInModal and the account
 * sign-in-methods status pill. Lucide has no Google logo (trademarked). */
export function GoogleGlyph({ className = "w-4 h-4" }: { className?: string }) {
  return (
